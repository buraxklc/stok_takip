...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Alım Raporu</h1>
        <div>
            <a href="<?php echo BASE_URL; ?>/report/generatePdf/purchases" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm me-2">
                <i class="fas fa-file-pdf fa-sm text-white-50 me-1"></i> PDF İndir
            </a>
            <a href="<?php echo BASE_URL; ?>/report/generateExcel/purchases" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="<?php echo BASE_URL; ?>/report/purchases" method="GET" class="row g-3 align-items-end">
                        <div class="col-md-3">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                Toplam Alım Sayısı</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $data['total_purchases']; ?></div>
                        </div>
                        <div class="col-auto">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">
                        Alımlar (<?php echo date('d.m.Y', strtotime($data['start_date'])); ?> - <?php echo date('d.m.Y', strtotime($data['end_date'])); ?>)
                    </h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php if(count($data['purchases']) > 0): ?>
                                    <?php foreach($data['purchases'] as $purchase): ?>
                                        <tr>
                                            ...
                                            <td><?php echo number_format($purchase['discount_amount'], 2, ',', '.') . ' ₺'; ?></td>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="10" class="text-center">Seçilen tarih aralığında alım kaydı bulunmamaktadır.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                            <tfoot>
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">En Çok Alınan Ürünler</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php if(count($data['top_purchased_products']) > 0): ?>
                                    <?php foreach($data['top_purchased_products'] as $product): ?>
                                        <tr>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="5" class="text-center">Henüz alım verisi bulunmamaktadır.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>

        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo BASE_URL; ?>/sale/create" method="POST" id="saleForm">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="customer_id" name="customer_id" required>
                                    ...
                                    <?php foreach($data['customers'] as $customer): ?>
                                        <option value="<?php echo $customer['id']; ?>"><?php echo $customer['name'] . ' (' . $customer['code'] . ')'; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control" id="sale_date" name="sale_date" value="<?php echo $data['today']; ?>" required>
                            </div>
                            
                            <div class="col-md-6 mb-3">
                                <label for="due_date" class="form-label">Vade Tarihi</label>
                                <input type="date" class="form-control" id="due_date" name="due_date">
                                <div class="form-text">Opsiyonel, vadeli satış için vade tarihini belirtin.</div>
                            </div>
                        </div>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="<?php echo BASE_URL; ?>/sale" class="btn btn-secondary me-md-2">İptal</a>
                            <button type="submit" class="btn btn-primary">Satış Oluştur</button>
                        </div>
                    </form>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateProductRow(row) {
        ...
        if (select.selectedIndex > 0) {
            ...
            // Miktar stok miktarını geçmesin

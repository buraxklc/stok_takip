<?php
// app/views/payments/supplier_index.php
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo BASE_URL; ?>/payment/createSupplierPayment" class="btn btn-primary">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo BASE_URL; ?>/payment/searchSupplierPayments" method="GET" class="mb-4">
                        <div class="input-group">
                            <input type="text" class="form-control" name="keyword" placeholder="Tedarikçi adı, kodu, fatura no veya referans no ile ara...">

<?php
// app/views/payments/supplier_view.php
        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3>Tedarikçi Ödemesi Detayları</h3>
                    <div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p><strong>Ödeme No:</strong> <?php echo $data['payment']['id']; ?></p>
                        ...
                        <div class="col-md-6">
                            ...
                            <p><strong>Tedarikçi:</strong> <?php echo $data['payment']['supplier_name']; ?></p>
                            <p><strong>Tedarikçi Kodu:</strong> <?php echo $data['payment']['supplier_code']; ?></p>
